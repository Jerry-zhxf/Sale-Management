...
<script>
     ...
     function deleteById(){
    	 ...
    	 if(count > 0){
    	 	 alert("确认删除？");
    		 formSubmit('suppleAction_delete','_self');
    	 }else{
     ...
     function toUpdate(){
    	 if(isOnlyChecked()){
    		 formSubmit('suppleAction_toupdate','_self')
    	 }else{
...
<div>
	<ul class="nav nav-pills">
	  <li><a href="#" onclick="formSubmit('suppleAction_tocreate','_self')"><img alt="add" src="${ctx }/img/add.png"></a></li>
	...
	<table class="table table-hover">
	  ...
	  <tbody>
	    ...
	    <tr>
	      ...
	      <td>${o.supplyInfo.vendorName}</td>
	      <td>${o.itemInfo.itemName}</td>
	      <td><fmt:formatDate value="${o.supplyDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	      <td>${o.supplyQuality }</td>
	      <td>${o.supplyPrice }</td>
	    </tr>
	    </c:forEach>
	  </tbody>
