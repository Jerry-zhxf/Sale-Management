...
<script>
     ...
     function deleteById(){
    	 ...
    	 if(count > 0){
    	 	 alert("确认删除？");
    		 formSubmit('transferAction_delete','_self');
    	 }else{
     ...
     function toUpdate(){
    	 if(isOnlyChecked()){
    		 formSubmit('transferAction_toupdate','_self')
    	 }else{
...
<div>
	<ul class="nav nav-pills">
	  <li><a href="#" onclick="formSubmit('transferAction_tocreate','_self')"><img alt="add" src="${ctx }/img/add.png"></a></li>
	...
	<table class="table table-hover">
	  ...
	  <tbody>
	    ...
	    <tr>
	      ...
	      <td>${o.storeInfoByOutStoreNo.storeNo}</td>
	      <td>${o.storeInfoByInStoreNo.storeNo}</td>
	      <td>${o.itemInfo.itemNo}</td>
	      <td>${o.itemInfo.itemName}</td>
	      <td><fmt:formatDate value="${o.transferDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	      <td>${o.transferQty}</td>
	    </tr>
	    </c:forEach>
	  </tbody>
