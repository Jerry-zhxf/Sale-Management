...
<script>
     ...
     function isOnlyChecked(){
    	 var checkBoxArray = document.getElementsByName('itemNo');
			count=0;
...
<div>
	...
	<table class="table table-hover">
	  <thead>
	    <tr>
	      <th>
	      	<input type="checkbox" name="selid" onclick="checkAll('itemNo',this)">
	      </th>
	      <th>序号</th>
	      <th>编号</th>
	      <th>名称</th>
	  ...
	  <tbody>
	    ...
	    <tr>
	      <td style="width: 60px"><input type="checkbox" name="itemNo" value="${o.itemNo}"/></td>
