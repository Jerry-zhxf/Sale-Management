...
/**
 * Send generated by hbm2java
 */
@Entity
@Table(name = "send", catalog = "saletest")
public class Send implements java.io.Serializable {
	...
	public Send(SendId id, ItemInfo itemInfo, StoreInfo storeInfo, Date sendDate) {
		this.id = id;
	...
	public Send(SendId id, ItemInfo itemInfo, StoreInfo storeInfo, Date sendDate, Float sendPrice, Long sendQty) {
		this.id = id;
		this.itemInfo = itemInfo;
		this.storeInfo = storeInfo;
		this.sendDate = sendDate;
