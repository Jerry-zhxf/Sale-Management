...
//			model3.setAmount(0F);
//			ItemInfo itemInfo = itemInfoService.get(ItemInfo.class, s);
//			model3.setItemInfo(itemInfo);
//		}
//		StoreItemsale storeItemsale = storeitemsaleService.get(StoreItemsale.class, storeItemsaleId);
//		storeItemsale.setSaleDate(model.getSaleDate());
//		storeItemsale.setSaleQty(storeItemsale.getSaleQty()+itemQty);
//		storeItemsale.setAmount(itemPrice);
