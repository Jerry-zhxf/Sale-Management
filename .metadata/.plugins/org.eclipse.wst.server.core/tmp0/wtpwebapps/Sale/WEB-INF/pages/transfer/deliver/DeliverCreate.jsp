...
<div class="col-md-6">
  <div class="form-group">
		...
		<div class="col-md-10">
			<s:select cssClass="form-control" name="id.storeNo" list="#storeInfo" headerKey="" headerValue="--请选择--" listKey="storeNo" listValue="storeName"></s:select>
		</div>
  </div>
  <div class="form-group">
		<label class="col-md-2 control-label">配送商品名称</label>
		<div class="col-md-10">
			<s:select cssClass="form-control" name="id.itemNo" list="#itemInfo" headerKey="" headerValue="--请选择--" listKey="itemNo" listValue="itemNo"></s:select>
		</div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label class="col-md-2 control-label">建议售价</label>
    <div class="col-md-10">
      <input type="text" class="form-control" name="sendPrice" placeholder="请输入建议售价">
    </div>
  </div>
</div>
</div>
